...
#[derive(Component, Debug, Clone, Copy, Hash, PartialEq, Eq, PartialOrd, Ord)]
pub enum Item {
    // Basic
    Rice,
    SeaWeed,
...
impl From<Item> for Vec2 {
    fn from(item: Item) -> Self {
        let size = match item {
            ...
            Item::Water => Self::new(200., 238.) * 0.45,
            Item::Dango => Self::new(200., 174.) * 0.4,
            Item::Leaf => Self::new(200., 146.) * 0.55,
            Item::Onigiri => Self::new(200., 197.) * 0.6,
            Item::Maki => Self::new(200., 205.) * 0.6,
            Item::Sushi => Self::new(200., 180.) * 0.65,
            Item::DangoStick => Self::new(475., 150.) * 0.5,
            Item::Tea => Self::new(200., 143.) * 0.75,
            Item::MisoSoup => Self::new(200., 169.) * 0.65,
            Item::MakiSushiTray => Self::new(400., 336.) * 0.65,
            Item::DangoTeaPlate => Self::new(400., 290.) * 0.60,
            Item::MakiSushiMisoTray => Self::new(550., 400.) * 0.65,
            Item::Boat => Self::new(871., 600.) * 0.65,
        };
        size * 0.75
    }
}
